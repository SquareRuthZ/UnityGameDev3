...
//move backward speed is less than normal speed by 60%
                transform.Translate(-transform.forward * (speedMagnitude * 0.4f) *
                    Time.deltaTime,Space.World);
            }
        }
        public static void ChangeSpeed(float speed)
        {
            m_DirectionalSpeed += 10;
        }
    }
}
